...
def main():
	...
	for i in range(1256,1500):
					if(p[i]=='TCP' or p[i]=='TLSv1'):
						if s[i]=='192.168.1.227':
							ips='10.0.1.1'
							ipd='34.205.236.24'
							dmac='00:00:0a:00:02:02'
							smac='9e:8d:de:80:29:28'
							pkt = Ether(src=smac, dst=dmac)
							pkt = pkt /IP(src=ips,dst=ipd) / TCP(sport=123, dport=50443)
							pkt.show2()
